 ...
 */
static inline int rs485_fifo_fill(struct device *dev, const u8_t *tx_data,
				 int size)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 */
static inline int rs485_fifo_read(struct device *dev, u8_t *rx_data,
				 const int size)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @return N/A
 */
static inline void rs485_irq_tx_enable(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @return N/A
 */
static inline void rs485_irq_tx_disable(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @retval 0 Otherwise.
 */
static inline int rs485_irq_tx_ready(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @return N/A
 */
static inline void rs485_irq_rx_enable(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @return N/A
 */
static inline void rs485_irq_rx_disable(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 * @retval 0 Otherwise.
 */
static inline int rs485_irq_tx_complete(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
 ...
 */
static inline int __deprecated rs485_irq_tx_empty(struct device *dev)
{
	return rs485_irq_tx_complete(dev);
}
 ...
 * @retval 0 Otherwise.
 */
static inline int rs485_irq_rx_ready(struct device *dev)
{
	const struct rs485_driver_api *api = dev->driver_api;
